...
\begin{slide}
  \subsection{KML przyk³ad}
  \begin{small}
\begin{flushright}
\vbox to0pt{\hsize=\textwidth
  \includegraphics[width=.66\hsize]{kml-example-0.png}
  \vss
}
\end{flushright}

    \advance\baselineskip-9pt
\begin{verbatim}
<?xml version="1.0" encoding="UTF-8"?>
...
<Document>
  <Placemark>
   ...
   <Point>
      <coordinates>
   18.5318800,54.5188900
      </coordinates>
   </Point>
  </Placemark>

 <Placemark>
   <rname>Hel-Elbl±g-WawA</name>
    <LineString>
      <coordinates>
    18.801300,54.6081400 19.4088400,54.1522000 21.011780,52.229770
      </coordinates>
    </LineString>
  </Placemark>
...
<Placemark> 
 <Polygon>   
   <name>Sopot-Poznañ-WawA</name>
  <outerBoundaryIs> 
   <LinearRing>
      <coordinates>
    18.560000,54.441800 16.929930,52.406920 19.466670,51.750000
    21.011780,52.229770
      </coordinates>
   </LinearRing> 
  </outerBoundaryIs> 
...
% %%%%%%%%%%%%
\begin{slide}
  \subsection{Materia³y do pobrania}
  %%%%%%%%%%%%%%
  %\null\vspace{1cm}
...
\begin{flushleft}  
  \begin{small}
    ...
    \url{https://github.com/hrpunio/Slides}\\
    \url{https://github.com/hrpunio/Z-MISC/tree/master/GFT}\\
